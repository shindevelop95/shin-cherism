...
function BlogPost() {
  ...
  return (
    <Container>
      <Wrapper>
        <Title>
          Looking for some 'Cherisome' inspiration? Here are some blog about our
          house plants
        </Title>
        <SubTitle textAlign="center">
          Blog, ShinWang, Inspiration, Plants
        </SubTitle>
        <Group>
          <LeftGroup>
            <Text>
            ...
            <Text>
              <span>Cherismifesta</span> are many variations of passages of
            ...
            <Card className={classes.root}>
              ...
              <CardActions disableSpacing>
                <Button color="primary">View More on Instagram</Button>
              </CardActions>
              <hr />
              <CardActions disableSpacing>
          ...
          <RightGroup>
            ...
            <Text data-aos="fade-left">
              ...
              versions from the 1914 translation by H. Rackham. The standard
            ...
            <hr />
            <Text data-aos="fade-left" fontWeight="bold">
              Follow us
            </Text>
